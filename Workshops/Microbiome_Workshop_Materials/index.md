...
⬣ If you do not have R and RStudio installed already, you can follow these [instructions](https://github.com/usfomicshub/microbiome_workshop/raw/master/PreCourseMaterials/r_installation_instructions_062020.pdf) for both Mac and Windows. If you already have RStudio, make sure you're using R version 4.0.3 -- "Bunny-Wunnies Freak Out" by clicking on 'Global Options...' in the **Tools** tab. The version is also stated in the first line of the console when you first open RStudio. If you are not using the most recent version, follow the previous installation instructions and restart R.
