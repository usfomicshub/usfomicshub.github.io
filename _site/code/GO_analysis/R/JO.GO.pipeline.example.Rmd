...
<link rel="canonical" href="http://localhost:4000/code/GO_analysis/R/JO.GO.pipeline.example.Rmd" />
<meta property="og:url" content="http://localhost:4000/code/GO_analysis/R/JO.GO.pipeline.example.Rmd" />
<meta property="og:site_name" content="USF Omics Hub" />
<script type="application/ld+json">
{"author":{"@type":"Person","name":"Author: J. Oberstaller"},"headline":"Gene functional-enrichment using JO&#39;s GO-analysis pipeline","description":"USF Omics Hub official github-repository: your landing-spot for finding our USF Genomics community-resources.","@type":"WebPage","url":"http://localhost:4000/code/GO_analysis/R/JO.GO.pipeline.example.Rmd","@context":"https://schema.org"}</script>
<!-- End Jekyll SEO tag -->
